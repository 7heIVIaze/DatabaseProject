		  	  	...
		  	  	<table class="table table-hover" style="width:100%;">
		      		<thead>
		    			<tr>
					      ...
					      <th scope="col">처방</th>
					      <th scope="col">진료병원이름</th>
					      <th scope="col">처방의사이름</th>
					      <th scope="col">증상</th>
					    </tr>
					</thead>
					<tbody>
						...
						try {
					        ...
					        String sql = "select h.id, h.hdate, h.prescription, d.name, p.name from history h join doctor d on h.did = d.id join hospital p on p.id = d.hid where cid = " + id;
							...
							%>
							    <tr>
							      ...
							      <td><%= docName %></td>
							      <td><%	
							      String query = "select symptom from mh_symptom where mhid = " + hid;
							      String result = "";
							      ResultSet rs2 = stmt2.executeQuery(query);
							      while(rs2.next()) {							    		  
							    	  result = result + rs2.getString(1);
							    		  result = result + " ";
							      }
							      rs2.close();
							      stmt2.close();
