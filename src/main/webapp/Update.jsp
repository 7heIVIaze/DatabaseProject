  	  ...
  	  <div class="row justify-content-start">
			  <jsp:include page="module/MypageSidebar.jsp" flush="false" />
		  	  <div class="col-md-9" style="white-space:nowrap;height:600px;padding-top: 50px">
					...
					<form style="padding-top: 20px; font-size: 17px;" action = "UpdateInfo.jsp" method = "post">
					
					  <div class="form-group row">
					    <label for="staticId" class="col-sm-2 col-form-label">이메일</label>
					    <div class="col-sm-10">
					      <input type="text" class="form-control" id="email" name="email" value= "<%= email %>">
					    </div>
					  </div>
					  <div class="form-group row" style="padding-top: 5px;">
					    <label for="staticBirthdate" class="col-sm-2 col-form-label">전화번호</label>
					    <div class="col-sm-10">
					  ...
					  <form style="padding-top: 20px; font-size: 17px;" action = "Withdrawal.jsp" method = "post">
